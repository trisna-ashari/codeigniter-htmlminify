Codeigniter Hooks - HTML Output Minify
...
1. Open config.php in ./application/config/config.php, find & change $config['enable_hooks'] = FALSE; to $config['enable_hooks'] = TRUE;
2. Copy and paste hooks.php file in ./application/config/hooks.php
3. Copy and paste htmlminify.php in ./application/hooks/htmlminify.php
